...
import { Card, CardActions, CardContent, IconButton, Typography, Tooltip, CardHeader } from '@mui/material';
...
const Archive = ({ archiveNote }) => {
    ...
    return (
        ...
        >
            <CardHeader style={{textAlign:"right",padding:"5px 5px 0 0"}} subheader={toCapitalize(archiveNote.status)}/>
